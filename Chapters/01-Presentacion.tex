...
\subsection{Justificación Teorica y Técnica}
...
Asimismo, se aborda la programación de horarios como un problema de optimización combinatoria clasificado como NP-Hard\cite{abdipoor_meta-heuristic_2023}. La investigación aporta valor teórico al demostrar que la gestión de restricciones "duras" y "blandas" en la asignación de recursos no es eficiente con planificación manual, justificando metaheurísticas y modelos predictivos para soluciones viables en espacios de búsqueda de alta complejidad\cite{abdipoor_meta-heuristic_2023}.
...
Además, esta investigación responde a los retos de la educación híbrida. Datos de 2025 indican que el 45\% de los problemas docentes se deben a aulas incompatibles con la modalidad virtual\cite{guadalupe_beltran_desafios_2025}. El sistema se justifica al incluir variables de infraestructura física y digital en la planificación, adaptando los espacios a los requisitos técnicos actuales.

\subsection{Justificación Económica}

La optimización de la oferta académica impacta directamente la sostenibilidad financiera de la institución. Predecir mal las tasas de inscripción genera costos innecesarios, como abrir secciones con baja demanda o saturar otras que exigen contratar docentes de emergencia\cite{shao_machine_2021}. Esta investigación reduce el error predictivo, mejora la eficiencia presupuestaria y ajusta los recursos a la demanda real, esencial en la Cuarta Revolución Industrial\cite{shenkoya_sustainability_2023}.

\subsection{Justificación Social}

Finalmente, el impacto principal es en el éxito estudiantil. La escasez de cupos en asignaturas clave, conocidas como "cuellos de botella", interrumpe el avance curricular y causa retrasos académicos\cite{stavrinides_course-prerequisite_2023}. Mediante análisis de redes, el sistema identifica estos puntos críticos y predice el riesgo de deserción por factores financieros y académicos con una precisión del 98.6\%\cite{shilbayeh_predicting_2021}. De este modo, optimiza procesos, promueve la continuidad educativa, permite el avance sin obstáculos administrativos, reduce las tasas de abandono y facilita la inserción oportuna en el mercado laboral.
